...
#         # Reorginize the order of the items - particularly the is_finished key (which is not present for leagues
#         #  still in process).
#         # if ('game_code' in keys) and ('is_finished' in keys):
#         #     d.pop('is_finished')
#         #     d.update({u'is_finished': u'1'})
#         # elif ('game_code' in keys) and ('is_finished' not in keys):
#         #     d.update({u'is_finished': u'0'})
